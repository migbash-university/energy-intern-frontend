...
<nav>
	...
	<img id='brand-img' src="./assets/img/edinburgh-napier-brand-img.png" height='48px' width='85px'
	...
	{#if segment == 'choose-preferred-time-slots' ||
		...
		<div style='width: min-content; margin: auto;'>
			...
			<svg id='checkpoint-marker' width="370" height="118" viewBox="0 0 370 118" fill="none" xmlns="http://www.w3.org/2000/svg">
